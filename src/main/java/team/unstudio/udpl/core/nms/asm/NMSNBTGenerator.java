...
public class NMSNBTGenerator implements Opcodes {
	...
	FieldVisitor fv;
	MethodVisitor mv;
	cw.visit(52, ACC_PUBLIC + ACC_SUPER, "team/unstudio/udpl/core/nms/asm/NMSNBT", null, "java/lang/Object", new String[] { "team/unstudio/udpl/api/nms/NMSNBT" });

	{
	fv = cw.visitField(ACC_PRIVATE + ACC_STATIC + ACC_SYNTHETIC, "$SWITCH_TABLE$team$unstudio$udpl$api$nbt$NBTBaseType", "[I", null, null);
	fv.visitEnd();
	}
	{
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toMap", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagCompound;", null, new String[] { "java/lang/Exception" });
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/server/v1_11_R1/NBTTagCompound", "c", "()Ljava/util/Set;", false);
	...
	Label l4 = new Label();
	mv.visitLabel(l4);
	mv.visitFrame(Opcodes.F_FULL, 6, new Object[] {"team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "java/lang/Object", "net/minecraft/server/v1_11_R1/NBTTagCompound", "team/unstudio/udpl/api/nbt/NBTTagCompound", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
	...
	mv.visitVarInsn(ALOAD, 2);
	mv.visitVarInsn(ALOAD, 4);
	mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/server/v1_11_R1/NBTTagCompound", "get", "(Ljava/lang/String;)Lnet/minecraft/server/v1_11_R1/NBTBase;", false);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toNBTBase", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTBase;", false);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTTagCompound", "set", "(Ljava/lang/String;Lteam/unstudio/udpl/api/nbt/NBTBase;)Lteam/unstudio/udpl/api/nbt/NBTTagCompound;", false);
	mv.visitInsn(POP);
	mv.visitLabel(l3);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toList", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagList;", null, new String[] { "java/lang/Exception" });
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	mv.visitFrame(Opcodes.F_FULL, 6, new Object[] {"team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "java/lang/Object", "net/minecraft/server/v1_11_R1/NBTTagList", "team/unstudio/udpl/api/nbt/NBTTagList", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
	mv.visitVarInsn(ALOAD, 3);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 2);
	mv.visitVarInsn(ILOAD, 4);
	mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/server/v1_11_R1/NBTTagList", "h", "(I)Lnet/minecraft/server/v1_11_R1/NBTBase;", false);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toNBTBase", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTBase;", false);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTTagList", "add", "(Lteam/unstudio/udpl/api/nbt/NBTBase;)Lteam/unstudio/udpl/api/nbt/NBTTagList;", false);
	mv.visitInsn(POP);
	Label l7 = new Label();
	mv.visitLabel(l7);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toByte", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagByte;", null, null);
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toShort", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagShort;", null, null);
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toInt", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagInt;", null, null);
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toLong", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagLong;", null, null);
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toFloat", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagFloat;", null, null);
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toDouble", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagDouble;", null, null);
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toString", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagString;", null, null);
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/server/v1_11_R1/NBTTagString", "c_", "()Ljava/lang/String;", false);
	mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/api/nbt/NBTTagString", "<init>", "(Ljava/lang/String;)V", false);
	mv.visitInsn(ARETURN);
	Label l1 = new Label();
	mv.visitLabel(l1);
	mv.visitLocalVariable("this", "Lteam/unstudio/udpl/core/nms/v1_11_R1/NMSNBT;", null, l0, l1, 0);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toByteArray", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagByteArray;", null, null);
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toIntArray", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagIntArray;", null, null);
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toNBTBase", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTBase;", null, new String[] { "java/lang/Exception" });
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toByte", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagByte;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l2);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toShort", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagShort;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l3);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toInt", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagInt;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l4);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toLong", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagLong;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l5);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toFloat", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagFloat;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l6);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toDouble", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagDouble;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l7);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toByteArray", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagByteArray;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l11);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toIntArray", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagIntArray;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l8);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toString", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagString;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l9);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toList", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagList;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l10);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toMap", "(Ljava/lang/Object;)Lteam/unstudio/udpl/api/nbt/NBTTagCompound;", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l12);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC, "toNBT", "(Lteam/unstudio/udpl/api/nbt/NBTBase;)Lnet/minecraft/server/v1_11_R1/NBTBase;", null, null);
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	mv.visitLineNumber(112, l0);
	mv.visitMethodInsn(INVOKESTATIC, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "$SWITCH_TABLE$team$unstudio$udpl$api$nbt$NBTBaseType", "()[I", false);
	mv.visitVarInsn(ALOAD, 1);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBase", "getType", "()Lteam/unstudio/udpl/api/nbt/NBTBaseType;", false);
	...
	mv.visitMethodInsn(INVOKESPECIAL, "net/minecraft/server/v1_11_R1/NBTTagByteArray", "<init>", "([B)V", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l6);
	...
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTTagString", "getValue", "()Ljava/lang/String;", false);
	mv.visitMethodInsn(INVOKESPECIAL, "net/minecraft/server/v1_11_R1/NBTTagString", "<init>", "(Ljava/lang/String;)V", false);
	mv.visitInsn(ARETURN);
	mv.visitLabel(l9);
	...
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTTagList", "getList", "()Ljava/util/List;", false);
	...
	Label l16 = new Label();
	mv.visitLabel(l16);
	mv.visitFrame(Opcodes.F_FULL, 5, new Object[] {"team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "team/unstudio/udpl/api/nbt/NBTBase", "net/minecraft/server/v1_11_R1/NBTTagList", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
	mv.visitVarInsn(ALOAD, 4);
	mv.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitVarInsn(ALOAD, 3);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toNBT", "(Lteam/unstudio/udpl/api/nbt/NBTBase;)Lnet/minecraft/server/v1_11_R1/NBTBase;", false);
	mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/server/v1_11_R1/NBTTagList", "add", "(Lnet/minecraft/server/v1_11_R1/NBTBase;)V", false);
	mv.visitLabel(l15);
	...
	mv.visitFrame(Opcodes.F_FULL, 2, new Object[] {"team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "team/unstudio/udpl/api/nbt/NBTBase"}, 0, new Object[] {});
	mv.visitVarInsn(ALOAD, 1);
	...
	mv.visitVarInsn(ALOAD, 3);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTTagCompound", "keySet", "()Ljava/util/Set;", false);
	mv.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
	...
	Label l22 = new Label();
	mv.visitLabel(l22);
	mv.visitFrame(Opcodes.F_FULL, 7, new Object[] {"team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "team/unstudio/udpl/api/nbt/NBTBase", Opcodes.TOP, "team/unstudio/udpl/api/nbt/NBTTagCompound", "net/minecraft/server/v1_11_R1/NBTTagCompound", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
	...
	mv.visitVarInsn(ALOAD, 3);
	mv.visitVarInsn(ALOAD, 5);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTTagCompound", "get", "(Ljava/lang/String;)Lteam/unstudio/udpl/api/nbt/NBTBase;", false);
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "toNBT", "(Lteam/unstudio/udpl/api/nbt/NBTBase;)Lnet/minecraft/server/v1_11_R1/NBTBase;", false);
	mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/server/v1_11_R1/NBTTagCompound", "set", "(Ljava/lang/String;Lnet/minecraft/server/v1_11_R1/NBTBase;)V", false);
	mv.visitLabel(l21);
	...
	{
	mv = cw.visitMethod(ACC_PUBLIC + ACC_BRIDGE + ACC_SYNTHETIC, "toNBT", "(Lteam/unstudio/udpl/api/nbt/NBTBase;)Ljava/lang/Object;", null, new String[] { "java/lang/Exception" });
	mv.visitCode();
	Label l0 = new Label();
	mv.visitLabel(l0);
	...
	{
	mv = cw.visitMethod(ACC_STATIC + ACC_SYNTHETIC, "$SWITCH_TABLE$team$unstudio$udpl$api$nbt$NBTBaseType", "()[I", null, null);
	mv.visitCode();
	Label l0 = new Label();
	Label l1 = new Label();
	Label l2 = new Label();
	...
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "$SWITCH_TABLE$team$unstudio$udpl$api$nbt$NBTBaseType", "[I");
	mv.visitInsn(DUP);
	Label l37 = new Label();
	...
	mv.visitInsn(POP);
	mv.visitMethodInsn(INVOKESTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "values", "()[Lteam/unstudio/udpl/api/nbt/NBTBaseType;", false);
	mv.visitInsn(ARRAYLENGTH);
	mv.visitIntInsn(NEWARRAY, T_INT);
	mv.visitVarInsn(ASTORE, 0);
	mv.visitLabel(l0);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "BYTE", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "BYTEARRAY", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "COMPOUND", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "DOUBLE", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "END", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "FLOAT", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "INTARRAY", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "INTEGER", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "LIST", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "LONG", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "SHORT", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
	mv.visitVarInsn(ALOAD, 0);
	mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/api/nbt/NBTBaseType", "STRING", "Lteam/unstudio/udpl/api/nbt/NBTBaseType;");
	mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/api/nbt/NBTBaseType", "ordinal", "()I", false);
	...
	mv.visitVarInsn(ALOAD, 0);
	mv.visitInsn(DUP);
	mv.visitFieldInsn(PUTSTATIC, "team/unstudio/udpl/core/nms/v1_11_R1/NMSNBT", "$SWITCH_TABLE$team$unstudio$udpl$api$nbt$NBTBaseType", "[I");
	mv.visitInsn(ARETURN);
	mv.visitMaxs(3, 1);
	mv.visitEnd();
	}
