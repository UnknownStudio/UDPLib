...
public class NmsNBTGenerator implements Opcodes {
	...
	public static byte[] generate(String nmsVersion) {
		...
		cw.visit(52, ACC_PUBLIC + ACC_SUPER, "team/unstudio/udpl/core/nms/asm/NmsNBT", null, "java/lang/Object",
				new String[] { "team/unstudio/udpl/nms/NmsNBT" });

		cw.visitSource("NmsNBT.java", null);

		{
			fv = cw.visitField(ACC_PRIVATE + ACC_STATIC + ACC_SYNTHETIC,
					"$SWITCH_TABLE$team$unstudio$udpl$nbt$NBTBaseType", "[I", null, null);
			fv.visitEnd();
		}
		{
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toCompound", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagCompound;",
					null, null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagCompound");
			mv.visitInsn(DUP);
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagCompound", "<init>", "()V", false);
			...
			mv.visitFrame(Opcodes.F_FULL, 6,
					new Object[] { "team/unstudio/udpl/core/nms/asm/NmsNBT", "java/lang/Object",
							"net/minecraft/server/"+nmsVersion+"/NBTTagCompound", "team/unstudio/udpl/nbt/NBTTagCompound",
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toNBTBase",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTBase;", false);
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagCompound", "set",
					"(Ljava/lang/String;Lteam/unstudio/udpl/nbt/NBTBase;)Lteam/unstudio/udpl/nbt/NBTTagCompound;",
					false);
			mv.visitInsn(POP);
			mv.visitLabel(l5);
			...
			mv.visitLocalVariable("oldNbt", "Lnet/minecraft/server/"+nmsVersion+"/NBTTagCompound;", null, l3, l9, 2);
			mv.visitLocalVariable("newNbt", "Lteam/unstudio/udpl/nbt/NBTTagCompound;", null, l4, l9, 3);
			mv.visitLocalVariable("key", "Ljava/lang/String;", null, l7, l5, 4);
			mv.visitMaxs(5, 6);
			mv.visitEnd();
		}
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toList", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagList;", null,
					null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagList");
			mv.visitInsn(DUP);
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagList", "<init>", "()V", false);
			mv.visitVarInsn(ASTORE, 3);
			Label l4 = new Label();
			mv.visitLabel(l4);
			...
			mv.visitFrame(Opcodes.F_FULL, 6,
					new Object[] { "team/unstudio/udpl/core/nms/asm/NmsNBT", "java/lang/Object",
							"net/minecraft/server/"+nmsVersion+"/NBTTagList", "team/unstudio/udpl/nbt/NBTTagList",
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toNBTBase",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTBase;", false);
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagList", "add",
					"(Lteam/unstudio/udpl/nbt/NBTBase;)Lteam/unstudio/udpl/nbt/NBTTagList;", false);
			mv.visitInsn(POP);
			Label l9 = new Label();
			mv.visitLabel(l9);
			...
			mv.visitLocalVariable("newNbt", "Lteam/unstudio/udpl/nbt/NBTTagList;", null, l4, l11, 3);
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toByte", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagByte;", null,
					null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagByte");
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			...
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagByte", "<init>", "(B)V", false);
			mv.visitInsn(ARETURN);
			Label l3 = new Label();
			mv.visitLabel(l3);
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toShort", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagShort;", null,
					null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagShort");
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			...
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagShort", "<init>", "(S)V", false);
			mv.visitInsn(ARETURN);
			Label l3 = new Label();
			mv.visitLabel(l3);
			mv.visitLocalVariable("this", "Lteam/unstudio/udpl/core/nms/asm/NmsNBT;", null, l0, l3, 0);
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toInt", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagInt;", null,
					null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagInt");
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			...
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagInt", "<init>", "(I)V", false);
			mv.visitInsn(ARETURN);
			Label l3 = new Label();
			mv.visitLabel(l3);
			mv.visitLocalVariable("this", "Lteam/unstudio/udpl/core/nms/asm/NmsNBT;", null, l0, l3, 0);
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toLong", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagLong;", null,
					null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagLong");
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			...
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagLong", "<init>", "(J)V", false);
			mv.visitInsn(ARETURN);
			Label l3 = new Label();
			mv.visitLabel(l3);
			mv.visitLocalVariable("this", "Lteam/unstudio/udpl/core/nms/asm/NmsNBT;", null, l0, l3, 0);
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toFloat", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagFloat;", null,
					null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagFloat");
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			...
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagFloat", "<init>", "(F)V", false);
			mv.visitInsn(ARETURN);
			Label l3 = new Label();
			mv.visitLabel(l3);
			mv.visitLocalVariable("this", "Lteam/unstudio/udpl/core/nms/asm/NmsNBT;", null, l0, l3, 0);
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toDouble", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagDouble;",
					null, null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagDouble");
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "net/minecraft/server/"+nmsVersion+"/NBTTagDouble");
			mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/server/"+nmsVersion+"/NBTTagDouble", MappingHelper.getMemberDeobf("NBTNumber", "h()D", "h"), "()D", false);
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagDouble", "<init>", "(D)V", false);
			mv.visitInsn(ARETURN);
			Label l3 = new Label();
			mv.visitLabel(l3);
			mv.visitLocalVariable("this", "Lteam/unstudio/udpl/core/nms/asm/NmsNBT;", null, l0, l3, 0);
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toString", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagString;",
					null, null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagString");
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			...
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagString", "<init>", "(Ljava/lang/String;)V",
					false);
			mv.visitInsn(ARETURN);
			Label l3 = new Label();
			mv.visitLabel(l3);
		...
		}
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toByteArray",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagByteArray;", null, null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagByteArray");
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			...
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagByteArray", "<init>", "([B)V", false);
			mv.visitInsn(ARETURN);
			Label l3 = new Label();
			mv.visitLabel(l3);
			mv.visitLocalVariable("this", "Lteam/unstudio/udpl/core/nms/asm/NmsNBT;", null, l0, l3, 0);
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toIntArray", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagIntArray;",
					null, null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitTypeInsn(NEW, "team/unstudio/udpl/nbt/NBTTagIntArray");
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			...
			mv.visitMethodInsn(INVOKESPECIAL, "team/unstudio/udpl/nbt/NBTTagIntArray", "<init>", "([I)V", false);
			mv.visitInsn(ARETURN);
			Label l3 = new Label();
			mv.visitLabel(l3);
			mv.visitLocalVariable("this", "Lteam/unstudio/udpl/core/nms/asm/NmsNBT;", null, l0, l3, 0);
		...
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toNBTBase", "(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTBase;", null,
					null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toByte",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagByte;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l4);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toShort",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagShort;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l5);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toInt",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagInt;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l6);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toLong",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagLong;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l7);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toFloat",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagFloat;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l8);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toDouble",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagDouble;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l9);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toByteArray",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagByteArray;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l13);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toIntArray",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagIntArray;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l10);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toString",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagString;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l11);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toList",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagList;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l12);
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toCompound",
					"(Ljava/lang/Object;)Lteam/unstudio/udpl/nbt/NBTTagCompound;", false);
			mv.visitInsn(ARETURN);
			mv.visitLabel(l14);
		...
		}
		{
			mv = cw.visitMethod(ACC_PUBLIC, "toNBT",
					"(Lteam/unstudio/udpl/nbt/NBTBase;)Lnet/minecraft/server/"+nmsVersion+"/NBTBase;", null, null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
			...
			mv.visitMethodInsn(INVOKESTATIC, "team/unstudio/udpl/core/nms/asm/NmsNBT",
					"$SWITCH_TABLE$team$unstudio$udpl$nbt$NBTBaseType", "()[I", false);
			Label l3 = new Label();
			mv.visitLabel(l3);
			mv.visitLineNumber(138, l3);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBase", "getType",
					"()Lteam/unstudio/udpl/nbt/NBTBaseType;", false);
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			mv.visitInsn(IALOAD);
			Label l4 = new Label();
			Label l5 = new Label();
			Label l6 = new Label();
			...
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagByte");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagByte", "getValue", "()B", false);
			...
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagShort");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagShort", "getValue", "()S", false);
			...
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagInt");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagInt", "getValue", "()I", false);
			...
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagLong");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagLong", "getValue", "()J", false);
			...
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagFloat");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagFloat", "getValue", "()F", false);
			...
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagDouble");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagDouble", "getValue", "()D", false);
			...
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagByteArray");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagByteArray", "getValue", "()[B", false);
			...
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagIntArray");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagIntArray", "getValue", "()[I", false);
			...
			mv.visitInsn(DUP);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagString");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagString", "getValue", "()Ljava/lang/String;",
					false);
			...
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagList");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagList", "getList", "()Ljava/util/List;",
					false);
			...
			mv.visitFrame(Opcodes.F_FULL, 5,
					new Object[] { "team/unstudio/udpl/core/nms/asm/NmsNBT", "team/unstudio/udpl/nbt/NBTBase",
							"net/minecraft/server/"+nmsVersion+"/NBTTagList", Opcodes.TOP, "java/util/Iterator" },
					0, new Object[] {});
			mv.visitVarInsn(ALOAD, 4);
			mv.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTBase");
			mv.visitVarInsn(ASTORE, 3);
			Label l19 = new Label();
			mv.visitLabel(l19);
			...
			mv.visitVarInsn(ALOAD, 0);
			mv.visitVarInsn(ALOAD, 3);
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toNBT",
					"(Lteam/unstudio/udpl/nbt/NBTBase;)Lnet/minecraft/server/"+nmsVersion+"/NBTBase;", false);
			...
			mv.visitFrame(Opcodes.F_FULL, 2,
					new Object[] { "team/unstudio/udpl/core/nms/asm/NmsNBT", "team/unstudio/udpl/nbt/NBTBase" }, 0,
					new Object[] {});
			mv.visitVarInsn(ALOAD, 1);
			mv.visitTypeInsn(CHECKCAST, "team/unstudio/udpl/nbt/NBTTagCompound");
			mv.visitVarInsn(ASTORE, 3);
			Label l21 = new Label();
			mv.visitLabel(l21);
			...
			mv.visitVarInsn(ALOAD, 3);
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagCompound", "keySet", "()Ljava/util/Set;",
					false);
			mv.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
			...
			mv.visitFrame(Opcodes.F_FULL, 7,
					new Object[] { "team/unstudio/udpl/core/nms/asm/NmsNBT", "team/unstudio/udpl/nbt/NBTBase",
							Opcodes.TOP, "team/unstudio/udpl/nbt/NBTTagCompound",
			...
			mv.visitVarInsn(ALOAD, 3);
			mv.visitVarInsn(ALOAD, 5);
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTTagCompound", "get",
					"(Ljava/lang/String;)Lteam/unstudio/udpl/nbt/NBTBase;", false);
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/core/nms/asm/NmsNBT", "toNBT",
					"(Lteam/unstudio/udpl/nbt/NBTBase;)Lnet/minecraft/server/"+nmsVersion+"/NBTBase;", false);
			...
			mv.visitLocalVariable("nbt", "Lteam/unstudio/udpl/nbt/NBTBase;", null, l0, l27, 1);
			mv.visitLocalVariable("nmsList", "Lnet/minecraft/server/"+nmsVersion+"/NBTTagList;", null, l16, l11, 2);
			mv.visitLocalVariable("nbtBase", "Lteam/unstudio/udpl/nbt/NBTBase;", null, l19, l17, 3);
			mv.visitLocalVariable("oldNbtMap", "Lteam/unstudio/udpl/nbt/NBTTagCompound;", null, l21, l15, 3);
			mv.visitLocalVariable("nmsMap", "Lnet/minecraft/server/"+nmsVersion+"/NBTTagCompound;", null, l22, l15, 4);
		...
		}
		{
			mv = cw.visitMethod(ACC_PUBLIC + ACC_BRIDGE + ACC_SYNTHETIC, "toNBT",
					"(Lteam/unstudio/udpl/nbt/NBTBase;)Ljava/lang/Object;", null, null);
			mv.visitCode();
			Label l0 = new Label();
			mv.visitLabel(l0);
		...
		{
			mv = cw.visitMethod(ACC_STATIC + ACC_SYNTHETIC, "$SWITCH_TABLE$team$unstudio$udpl$nbt$NBTBaseType", "()[I",
					null, null);
			mv.visitCode();
			Label l0 = new Label();
			Label l1 = new Label();
			...
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/core/nms/asm/NmsNBT",
					"$SWITCH_TABLE$team$unstudio$udpl$nbt$NBTBaseType", "[I");
			mv.visitInsn(DUP);
			Label l37 = new Label();
			...
			mv.visitInsn(POP);
			mv.visitMethodInsn(INVOKESTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "values",
					"()[Lteam/unstudio/udpl/nbt/NBTBaseType;", false);
			...
			mv.visitLabel(l0);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "BYTE",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "BYTEARRAY",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "COMPOUND",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "DOUBLE",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "END",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "FLOAT",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "INTARRAY",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "INTEGER",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "LIST",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "LONG",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "SHORT",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
			...
			mv.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETSTATIC, "team/unstudio/udpl/nbt/NBTBaseType", "STRING",
					"Lteam/unstudio/udpl/nbt/NBTBaseType;");
			mv.visitMethodInsn(INVOKEVIRTUAL, "team/unstudio/udpl/nbt/NBTBaseType", "ordinal", "()I", false);
