package team.unstudio.udpl.api.jsonmessage;
...
import team.unstudio.udpl.api.item.ItemHelper;
...
import static team.unstudio.udpl.api.jsonmessage.TextualComponent.rawText;
...
public class JsonMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	/**
	 * Set the behavior of the current editing component to instruct the client to append the chat input box content with the specified string when the currently edited part of the {@code JsonMessage} is SHIFT-CLICKED.
	 * The client will not immediately send the command to the server to be executed unless the client player submits the command/chat message, usually with the enter key.
	 *
	 * @param command The text to append to the chat bar of the client.
	 * @return This builder instance.
	 */
	public JsonMessage insert(final String command) {
	...
	public JsonMessage itemTooltip(final ItemStack itemStack) {
		onHover("show_item", new JsonString(ItemHelper.toJson(itemStack)));
		return this;
	}
	 ...
	 * @return This builder instance.
	 */
	public JsonMessage translationReplacements(final String... replacements) {
	 ...
	 * @return This builder instance.
	 */   /* ------------
	public JsonMessage translationReplacements(final Iterable<? extends CharSequence> replacements){
