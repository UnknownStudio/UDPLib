...
public final class MemberMapping {
    ...
    public boolean containObf(String className, String obfName, String desc) {
        if (!obf2Deobf.containsKey(className)) return false;
